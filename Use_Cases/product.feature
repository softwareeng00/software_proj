...
And User enter information of product id "3",type "carpet",name "Textured ",image "pic1.jpg",description "Lint threads",special treatment "VIP", high "3",width "2" ,flagprod "false"
When Creating product succes flagproduct "false"
...
And Update product with  id "3",type "carpet", name "Axminster carpets",image "pic1.jpg",description "Lint threads", special treatment "NOT VIP", high "3",width "2" ,flagprodupdate "true"
When Product update success string "false"
