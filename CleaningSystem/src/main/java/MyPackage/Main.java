	 ...
	 if(userselected==3)//Customer
	 {
		...
		{String C1 = null;String C2; 
			...
			case 1 : 
				...
				P.createProduct(g.toString(), M.name, M.type, M.image, M.image, M.specialtreatment,M.high,M.width);
			...
			case 2:
				...
				if(M1.name==null) {
				nameofprod=P1.name;}
				P1.updateProduct(in.toString(), M1.type, M1.name, M1.image, M1.description, M1.specialtreatment,M1.high,M1.width);
			...
			case 4:
				...
				for(int i=0;i<Customer.user1.size();i++) {
					...
					if(Customer.user1.get(i).getEmail().equals(emails) ) {
						...
						Bill B=new Bill();
						int BILL=B.priceProd(nameofprod);
						System.out.println("*		Price " +BILL+"$"+	"		  *");
						System.out.println("*		Delivary 20$" +		"		  *");
						System.out.println("*		Total Price " +B.totalPriceofproduct(BILL)+"$"+"	  *");
						System.out.println("* * * * * * * * * * * * * * * * * * * * * *");
					}
				}
	...
	public static int AdminMenu()
	{
		int selection ;
		 Scanner sc = new Scanner(System.in);
			...
			System.out.println("★	6- Product in waiting  ★");
			System.out.println("★★★★★★★★★★★★★★★★★★★★★★★★");
			System.out.print("Select your option : ");
			selection=sc.nextInt();
